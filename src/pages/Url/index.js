...
function Url() {
  ...
  return (
    <div className={styles.config}>
      ...
      <p>L'url attendu est du type 192.168.1.11:5001 ou bien un nom de domaine par exemple https://rcweb.fr</p>
      ...
      <input type="text" placeholder="Url" onChange={handlerUrl} />
